            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <input type="number" name="jumlah_anak" id="jumlah_anak" value="{{ $anggota->jumlah_anak }}" required class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm">
                    </div>
                </div>
