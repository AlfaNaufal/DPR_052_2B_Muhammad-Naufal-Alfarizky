...
@section('content')
    <div class="container mx-auto">
        <div class="flex justify-between items-center mb-6">
            <h1 class="text-3xl font-bold text-gray-800">Data Penggajian</h1>
        </div>
                    ...
                    <tbody>
                        @forelse ($anggotaAll as $anggota)
                            <tr class="bg-white border-b hover:bg-gray-50">
                                ...
                                <td class="px-6 py-4">
                                    <a href="{{ route('public.penggajian.detail', $anggota->id_anggota) }}" class="font-medium text-blue-600 hover:underline">Detail</a>
                                </td>
                            </tr>
                        @empty
                            <tr>
